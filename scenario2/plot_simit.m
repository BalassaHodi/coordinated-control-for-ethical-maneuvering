...
korm=[0:Ts:steps*Ts;0 kormanyszog(2:length(kormanyszog))*180/pi];
j=2;
korm2=[0;0];
for i=0.1:0.01:2
    korm2(1,j)=i;
...
figure; %hold on;
plot([0:Ts:steps*Ts],[0 sebesseg(2:length(sebesseg))]);
seb=[0:Ts:steps*Ts;0 sebesseg(2:length(sebesseg))];
j=2;
seb2=[0;va];
for i=0.1:0.01:2
    seb2(1,j)=i;
